...
(function () {
  ...
  if ( document.querySelectorAll( '.input-box__field_format_card' ).length ) {
    let inputCard = new Cleave('.input-box__field_format_card', {
      delimiter: '-',
      blocks: [5, 2],
      uppercase: true
    });
  ...
  if ( document.querySelectorAll( '.input-box__field_format_phone' ).length ) {
    let inputPhone = new Cleave('.input-box__field_format_phone', {
      phone: true,
      phoneRegionCode: 'ru'
    });
  }
