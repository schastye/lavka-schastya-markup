...
;( function( window ) {
	...
	ElastiStack.prototype._moveAway = function( instance ) {
		...
		// add class "animate"
		classie.add( instance.element, 'elasticstack__item_animate' );
		...
		if( item2 ) {
			classie.add( item2, 'elasticstack__item_move-back' );
			classie.add( item2, 'elasticstack__item_animate' );
			setTransformStyle( item2, is3d ? 'translate3d(0,0,-60px)' : 'translate(0,0)' );
		}
		if( item3 ) {
			classie.add( item3, 'elasticstack__item_move-back' );
			classie.add( item3, 'elasticstack__item_animate' );
			setTransformStyle( item3, is3d ? 'translate3d(0,0,-120px)' : 'translate(0,0)' );
		}
		...
		var self = this,
			onEndTransFn = function() {
				...
				classie.remove( instance.element, 'elasticstack__item_animate' );
				...
				classie.remove( item1, 'elasticstack__item_move-back' );
				if( item2 ) classie.remove( item2, 'elasticstack__item_move-back' );
				if( item3 ) classie.remove( item3, 'elasticstack__item_move-back' );

				setTimeout( function() {
					// the upcoming one will animate..
					classie.add( self._lastItem(), 'elasticstack__item_animate' );
					// reset style
					self._setStackStyle();
				}, 25 );
	...
	ElastiStack.prototype._moveBack = function( instance ) {
		...
		classie.add( instance.element, 'elasticstack__item_move-back' );
		classie.add( instance.element, 'elasticstack__item_animate' );
	...
	ElastiStack.prototype._onDragStart = function( instance, event, pointer ) {
		...
		classie.remove( instance.element, 'elasticstack__item_move-back' );
		classie.remove( instance.element, 'elasticstack__item_animate' );

		if( item2 ) {
			classie.remove( item2, 'elasticstack__item_move-back' );
			classie.remove( item2, 'elasticstack__item_animate' );
		}
		if( item3 ) {
			classie.remove( item3, 'elasticstack__item_move-back' );
			classie.remove( item3, 'elasticstack__item_animate' );
		}
	};
